...
const navigatorLanguage = typeof navigator !== 'undefined' ? navigator.language.slice(0, 2) : 'en';
const defaultLanguage = ['en', 'fr', 'de', 'nl'].includes(navigatorLanguage) ? navigatorLanguage : 'en';
